...
//
//    [UMSocialData defaultData].extConfig.title = @"驾校中国";
//    [UMSocialData defaultData].extConfig.qqData.url = url;
//    [UMSocialData defaultData].extConfig.qzoneData.url = url;
//    [UMSocialData defaultData].extConfig.wechatSessionData.url = url;
//    [UMSocialData defaultData].extConfig.wechatTimelineData.url = url;
//    [UMSocialSnsService presentSnsIconSheetView:ws
//                                         appKey:@"574d354067e58e201d0003dd"
//                                      shareText:title
...
+ (void)showWithFram:(CGRect)fram propmt:(NSString *)propmt onView:(UIView *)view{
    ...
    UILabel *label = [MyControl labelWithTitle:propmt color:[UIColor grayColor] fontOfSize:14 numberOfLine:1];
    label.textAlignment = NSTextAlignmentCenter;
    [nodataView addSubview:label];
    
    [label mas_makeConstraints:^(MASConstraintMaker *make) {
        make.center.width.equalTo(nodataView);
        make.height.mas_equalTo(20);
    }];
